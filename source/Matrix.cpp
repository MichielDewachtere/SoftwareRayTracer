...
namespace dae {
	...
	Matrix Matrix::CreateTranslation(float x, float y, float z)
	{
		//todo W1
		Matrix translation{};
		translation[0] = Vector4{ 1,0,0,0 };
		translation[1] = Vector4{ 0,1,0,0 };
		translation[2] = Vector4{ 0,0,1,0 };
		translation[3] = Vector4{ x,y,z,1 };
	...
	Matrix Matrix::CreateRotationX(float pitch)
	{
		//todo W1
		Matrix rotation{};
		rotation[0] = Vector4{ 1,0,0,0 };
		rotation[1] = Vector4{ 0,cosf(pitch),-sinf(pitch),0 };
		rotation[2] = Vector4{ 0,sinf(pitch),cosf(pitch),0 };
	...
	Matrix Matrix::CreateRotationY(float yaw)
	{
		//todo W1
		Matrix rotation{};
		rotation[0] = Vector4{ cosf(yaw),0,-sinf(yaw),0 };
		rotation[1] = Vector4{ 0,1,0,0 };
		rotation[2] = Vector4{ sinf(yaw),0,cosf(yaw),0 };
		rotation[3] = Vector4{ 0,0,0,1 };
	...
	Matrix Matrix::CreateRotationZ(float roll)
	{
		//todo W1		
		Matrix rotation{};
		rotation[0] = Vector4{ cosf(roll),sinf(roll),0,0};
		rotation[1] = Vector4{ -sinf(roll),cosf(roll),0,0};
		rotation[2] = Vector4{ 0,0,1,0 };
		rotation[3] = Vector4{ 0,0,0,1 };
	...
	Matrix Matrix::CreateRotation(const Vector3& r)
	{
		//todo W1		
		Matrix rotation{};
		rotation[0] = Vector4{ cosf(r.x),0,sinf(r.x),0 };
		rotation[1] = Vector4{ sinf(r.x) * sinf(r.z),cosf(r.z),-sinf(r.z) * cosf(r.x),0 };
		rotation[2] = Vector4{ cosf(r.z) * sinf(r.x),sinf(r.z),cosf(r.z) *	cosf(r.x),0 };		
		rotation[3] = Vector4{ 0,0,0,1 };
	...
	Matrix Matrix::CreateScale(float sx, float sy, float sz)
	{
		//todo W1
		Matrix scale{};
		scale[0] = Vector4{ sx,0,0,0 };
		scale[1] = Vector4{ 0,sy,0,0 };
		scale[2] = Vector4{ 0,0,sz,0 };
		scale[3] = Vector4{ 0,0,0,1 };
